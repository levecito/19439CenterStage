...
@Autonomous(name = "LM2 Auto")
public class AutonomousLM2 extends OpMode {
    ...
    private AutonomousLM2.AutoState autoState = AutonomousLM2.AutoState.INIT;
    ...
    public void init() {
        ...
        autoState = AutonomousLM2.AutoState.MOVE_FORWARD;
    }
    @Override
    public void loop() {
        switch (autoState) {
            case MOVE_FORWARD:
                ...
                break;
            case TURN:
                drivetrain.autoDrive(0, 1, 0, 1000);
                drivetrain.autoDrive(1, 0, 0, 2000);
